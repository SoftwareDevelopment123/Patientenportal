...
public class CaseWSImpl implements CaseWS {
	 ...
	 * Bei Doktoren und Verwandten wird geprüft, ob man beim angefragten Fall
	 * Leserechte hat.<br>
	 * 
	 ...
	 * Dementsprechend wird nur das Token benötigt, aus dem dann die ihm
	 * zugehörige ID abgerufen wird.<br>
	 * 
	 ...
	 * erstellten Fall und wird der Doktorliste des Falls hinzugefügt. Hier wird
	 * sichergestellt, dass auch mitgegebene Doktoren dem Fall hinzugefügt
	...
	/**
	 * <b>Fall löschen</b><br>
	 * Fälle sollten eigentlich nicht gelöscht, sondern nur geschlossen
	 * werden.<br>
	 * Zur Vollständigkeit ist diese Methode trotzdem vorhanden, die
	 * Berechtigung für den Doctor kann ggf. noch entfernt werden.
	 * 
	 * Zugriffsbeschränkung: <code>Doctor</code> (unter Vorbehalt) mit
	...
	/**
	 * <b>Fall updaten</b><br>
	 * Hier ist zu beachten, dass möglichst eine Vollständige
