...
public class RightsDAO {
	 ...
	 * 
	 * @param rights
	 *            - Entity mit dem zu erstellenden Recht <br>
	 ...
	 * Sinnvollerweise kann nur das Schreibrecht bearbeitet werden, in anderen
	 * Use-Cases sollte ein neues Recht angelegt, bzw., dieses gelöscht werden.
	 * 
	 * @param rights
	 *            Entity des betroffenen Rechts
	 * @return <code>String</code> mit Erfolgsmeldung oder Fehler
	 */
	 ...
	 * 
	 * @param <code>int</code>
	 *            rightID des betroffenen Rechts
	 * @return <code>String</code> mit Erfolgsmeldung oder Fehler
	 */
	...
	/**
	 * Datenbankzugriff zum: Abruf aller Fälle, bei denen ein Doktor Leserechte
	 * hat.<br>
	 * Da hier oft eine große Menge an Daten abgerufen wird, werden primär nicht
	 * benötigte Informationen auf <code>null</code> gesetzt und können mit
	 * getCase dann vollständig abgerufen werden, falls benötigt.
	 * 
	 * @param doctorID
	...
	/**
	 * Datenbankzugriff zum: Abruf aller Fälle, bei denen ein Verwandter
	 * Leserechte hat. <br>
	 * Da hier oft eine große Menge an Daten abgerufen wird, werden primär nicht
	 * benötigte Informationen auf <code>null</code> gesetzt und können mit
	 * getCase dann vollständig abgerufen werden, falls benötigt.
	...
	/**
	 * Datenbankzugriff zum: Prüfen, ob ein Doktor beim gegebenen Fall Lese-
	 * oder Schreibrechte hat.
	 * 
	 * @param access
	 *            <code>Access</code> Enum: WriteCase oder ReadCase, je nach
	 *            Prüfung
	 * @return <code> boolean</code> true, wenn der Doktor Lese-, bzw.
	 *         Schreibrechte hat
	 */
	...
	/**
	 * Datenbankzugriff zum: Prüfen, ob ein Verwandter beim gegebenen Fall Lese-
	 * oder Schreibrechte hat.
	 * 
	 * @param access
	 *            <code>Access</code> Enum: WriteCase oder ReadCase, je nach
	 *            Prüfung
	 * @return <code> boolean</code> true, wenn der Verwandter Lese-, bzw.
	 *         Schreibrechte hat
	 */
