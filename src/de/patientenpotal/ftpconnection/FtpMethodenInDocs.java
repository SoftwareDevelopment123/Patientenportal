...
public class FtpMethodenInDocs {
	...
	public static void downloadInstructionDoc(InstructionDoc indoctodownload) {
		...
		String filetodownload = File.separator + "InstructionDoc" + indoctodownload.getInstructionDocID() + "."
		...
		File downloadfileto = new File(
				"C:" + File.separator + "Users" + File.separator + "Jani" + File.separator + "Desktop" + File.separator
						+ "Filezilla" + File.separator + "Download" + File.separator + indoctodownload.getTitle()
						+ indoctodownload.getInstructionDocID() + "." + indoctodownload.getFileType());

		FTPClient ftpClient = new FTPClient();
		try {

			System.out.println("Starting Download of the Medicaldocument: " + indoctodownload.getTitle()
					+ indoctodownload.getFileType());
			...
			if (success) {
				System.out.println("The Instruction Document: " + indoctodownload.getTitle()
						+ indoctodownload.getFileType() + " has been downloaded sucessfully.");
			}
			if (!success) {
				System.out.println("The Instruction Document: " + indoctodownload.getTitle()
						+ indoctodownload.getFileType() + " has not been found on the server.");
