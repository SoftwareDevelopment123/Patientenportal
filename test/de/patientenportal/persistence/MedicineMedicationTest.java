...
public class MedicineMedicationTest {
	...
	public void main() {
		...
		Assert.assertEquals(m1.getPrescribedBy().getSpecialization(),
				getmedication1.getPrescribedBy().getSpecialization());
		...
		Assert.assertEquals(m1.getMedicine().getName(),
				MedicineDAO.getMedicine(getcase.getMedication().get(0).getMedicine().getMedicineID()).getName());
		...
		Assert.assertEquals(newmedication.getPrescribedBy().getDoctorID(),
				medicationUtest.getPrescribedBy().getDoctorID());
		Assert.assertEquals(newmedication.getPrescribedBy().getSpecialization(),
				medicationUtest.getPrescribedBy().getSpecialization());
