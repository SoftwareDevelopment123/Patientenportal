...
public class RightsTest {
	...
	public void main() {
		...
		// Ausgabe-Test
		/*
		 * System.out.println("Zugewiesene Rechte - Fall " +
		 * changedCase.getCaseID()); for (Rights right : rlist){
		 * System.out.print("Recht-ID: " + right.getRightID());
		 * System.out.print(" / Fall-ID: " + right.getPcase().getCaseID()); if
		 * (right.getDoctor() != null) {System.out.print(" / Doctor-ID   " +
		 * right.getDoctor().getDoctorID());} if (right.getRelative() != null)
		 * {System.out.print(" / Relative-ID " +
		 * right.getRelative().getRelativeID());}
