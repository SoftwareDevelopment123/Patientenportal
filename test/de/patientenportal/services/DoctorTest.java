...
public class DoctorTest {
	...
	public void main() throws MalformedURLException, AuthenticationException, AccessException, AuthorizationException,
		...
		/*
		 * Get DoctorList by Patient zum manuellen Testen vorgesehen, wird sonst
		 * zu kompliziert (für mehr Komplexität mehr Fälle zu Patient 1 zuweisen
		 * Aktueller Stand: funktioniert
		 */

		/*
		 * Accessor getDocList2 = new Accessor(1); DoctorListResponse
		 * docListResponse2 = doc.getDoctorsByP(getDocList2);
		 * 
		 * List<Doctor> docList2 = docListResponse2.getResponseList(); for
		 * (Doctor d : docList2) { System.out.print("Doktor-ID: " +
